...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNumberView = (AutoCompleteTextView) findViewById(R.id.withText);
        populateAutoComplete();


        Button mNumberSignInButton = (Button) findViewById(R.id.sign_in_button);
        mNumberSignInButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                intent= new Intent(LoginActivity.this,LandingPage.class);
